...
// LowVRAMThreshold controls when the server enables low VRAM mode
var LowVRAMThreshold = Uint64("OLLAMA_LOW_VRAM_THRESHOLD", 20*format.GibiByte)
...
func AsMap() map[string]EnvVar {
	ret := map[string]EnvVar{
		...
		"OLLAMA_LOW_VRAM_THRESHOLD": {"OLLAMA_LOW_VRAM_THRESHOLD", LowVRAMThreshold(), "Minimum total VRAM (bytes) before Ollama enters low VRAM mode"},
